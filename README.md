...
|---|---|
| [cypress-e2e-suite](https://github.com/arlex13/cypress-e2e-suite) | Suite de automatización E2E + API organizada por feature |
| [jenkins-devsecops-pipeline](https://github.com/arlex13/jenkins-devsecops-pipeline) | Pipeline DevSecOps con SCA, Trivy, ZAP y Security Gate |
| [cypress-framework](https://github.com/arlex13/cypress-framework) | Arquitectura de testing con Page Object Model |
| [tuleapp-qa-workflow](https://github.com/arlex13/tuleapp-qa-workflow) | Gestión de QA: plan, templates y trazabilidad |
